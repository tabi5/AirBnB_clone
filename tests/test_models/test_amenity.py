#!/usr/bin/python3
"""it Defines unittests for models/amenity.py.
...
class TestAmenity_save(unittest.TestCase):
    """Unittests for testing a save method of the Amenity class."""
    ...
    def setUp(self):
        ...
        self.first_updated_at = self.amenity.updated_at

    def tearDown(self):
        self.amenity = None
        self.first_updated_at = None

    def test_one_save(self):
        sleep(0.05)
        self.amenity.save()
        self.assertLess(self.first_updated_at, self.amenity.updated_at)

    def test_two_saves(self):
        sleep(0.05)
        self.amenity.save()
        second_updated_at = self.amenity.updated_at
        self.assertLess(self.first_updated_at, second_updated_at)
        sleep(0.05)
        self.amenity.save()
...
class TestAmenityToDict(unittest.TestCase):
    ...
    def test_to_dict_type(self):
        self.assertEqual(dict, type(self.amenity.to_dict()))
